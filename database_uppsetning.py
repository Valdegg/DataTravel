...
with con: 
	...
	cur = con.cursor()
	cur.execute("DROP TABLE WeatherChancesEurope")
	...
	cur.execute('CREATE TABLE WeatherChancesEurope(city text, week date, "tempoversixty" integer, "tempoverninety" integer, "tempbelowfreezing" integer, "tempoverfreezing" integer, windy integer, "partlycloudy" integer, "sunnycloudy" integer, cloudy integer,  humid integer, fog integer, precipitation integer, rain integer, snow integer, "snowonground" integer, sultry integer, thunder integer, tornado integer, hail integer)')
